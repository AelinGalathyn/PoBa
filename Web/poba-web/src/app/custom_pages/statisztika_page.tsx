            ...
            <div className="h-full w-full mt-5 pe-2 bg-gray-200 rounded-lg shadow-gray-400 shadow-inner overflow-hidden hover:overflow-auto scroll-smooth">
                <div className="grid grid-cols-2">
                    <div className="h-full text-center flex flex-col justify-center items-center">
                        {!isLinear ?
                            <LinearChartWeek title="Heti rendelések" label="db" isChart1={true}/>
                            :
                            <CircleChartWeek title="Heti rendelések" label="db" isChart1={true}/>
                        }
                        <Spacer/>
                    ...
                    <div className="h-full text-center flex flex-col justify-center items-center">
                        {!isLinear2 ?
                            <LinearChartWeek title="Heti bevétel" label="Ezer Ft" isChart1={false}/>
                            :
                            <CircleChartWeek title="Heti bevétel" label="Ezer Ft" isChart1={false}/>
                        }
                        <Spacer/>
